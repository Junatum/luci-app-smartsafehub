...
- README의 IPTV Beta 배지 설명을 접힌 사이드바의 단일 `β` 원형 배지 동작에 맞게 갱신했습니다. 프런트엔드 빌드 산출물은 생성하지 않습니다.
...
- README의 IPTV Beta 설명을 접힌 사이드바에서도 읽기 쉬운 Beta 배지를 유지하는 동작에 맞게 갱신했습니다. 프런트엔드 빌드 산출물은 생성하지 않습니다.
...
- README의 IPTV Beta 설명을 현재 provider/profile UI와 저장되지 않은 설정 경고 동작에 맞게 갱신했습니다. 프런트엔드 빌드 산출물은 생성하지 않습니다.
...
- README에 패키지 업그레이드 시 rpcd self-heal 정책을 문서화했습니다. 프런트엔드 빌드 산출물은 생성하지 않습니다.
...
- README에 IPTV Beta 기능, 의존성, 적용 방식과 현재 지원 범위를 문서화했습니다. 프런트엔드 빌드 산출물은 생성하지 않습니다.
...
- README에 maintenance 서비스의 업그레이드 복구 정책과 postinst 서비스 enable 동작을 문서화했습니다. 프런트엔드 빌드 산출물은 생성하지 않습니다.
...
- README의 선택 컨트롤 설명을 공통 커스텀 드롭다운 동작에 맞게 갱신했습니다. 프런트엔드 빌드 산출물은 생성하지 않습니다.
...
- `tests/test-safeshield-page-contract.sh`에 정적 ULTIMATE/PRO/기타 유료 플랜 surface, glow·shine 제거, 다크 모드 ULTIMATE 규칙 단일 정의를 검증하는 소스 스타일 계약을 추가했습니다. 프런트엔드 빌드 산출물은 패치에서 생성하지 않습니다.
